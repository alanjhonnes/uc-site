	...
	<body class="no-trans ">
		...
		<div class="page-wrapper">
						...
						<div class="slider-banner-fullscreen">
							<ul class="slides">
								...
								<li data-transition="slidehorizontal" data-slotamount="1"  data-masterspeed="1000" data-fstransition="fade" data-fsmasterspeed="1000" data-saveperformance="off" data-title="Boost your online presence">
									...
									<!-- main image -->
									<img src="template/videos/video-banner-poster.jpg" alt="slidebg1" data-bgposition="center center"  data-bgrepeat="yes-repeat" data-bgfit="cover">
									...
									<div class="tp-caption tp-fade fadeout fullscreenvideo"
										...
										data-nextslideatend="false"
							 			...
							 			data-forcerewind="on" 
							 			style="z-index: 2;">
										<video class="" preload="none" width="100%" height="100%" poster='template/videos/video-banner-poster.jpg'> 
											<source src='template/videos/background-video-banner.mp4' type='video/mp4'/>
											<source src='template/videos/background-video-banner.webm' type='video/webm'/>
										</video>
									</div>
									...
									<div class="tp-caption sfb fadeout large_white text-right"
										...
										data-speed="500"
										data-start="1000"
										data-easing="easeOutQuad"><span class="logo-font"><BR></span><br><br>Conectando o perfil<br>ideal à sua marca<br>
									</div>	
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div align="center" class="col-sm-3">
									...
									<br>
									<h2 class="text-center title">Crie seu <strong>Portfólio</strong></h2>
									<p class="large text-center" style="text-align:center;"><font size="3.5">Adicione suas melhores fotos e vídeos. Mostre que você é especial!</font></p>
								</div>	
								<div align="center" class="col-sm-3">
			...
			<!--<div class="container">
					<div class="row">
						<div class="col-md-12">
							<section class="dark-translucent-bg parallax background-img-10 pv-40" class="img-responsive"style="background-position: 90% 50%;">
			...
			<!--<section id="Cadastros"  class="section clearfix">
				<div class="container">
					<div class="row">		
						<h2 class="text-center">Últimos <strong><font color="#00ccde">Contratados</strong></font></h2>
						<div class="separator"></div>
								<div class="owl-carousel carousel-autoplay">
									<div class="pv-30 ph-20 feature-box bordered shadow light-gray-bg text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
									...
									<div class="pv-30 ph-20 feature-box bordered shadow light-gray-bg text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
												<h3>Project Title6</h3>
												<div class="separator"></div>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus? Voluptatem distinctio laborum porro aspernatur.</p>
									</div>
									<div class="pv-30 ph-20 feature-box bordered shadow light-gray-bg text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
												<h3>Project Title7</h3>
												<div class="separator"></div>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus? Voluptatem distinctio laborum porro aspernatur.</p>
									</div>
									<div class="pv-30 ph-20 feature-box bordered shadow light-gray-bg text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
												<h3>Project Title8</h3>
												<div class="separator"></div>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus? Voluptatem distinctio laborum porro aspernatur.</p>
									</div>
								</div>
					...
					<div class="separator"></div>
						<div class="row">
							...
							<!--<div class="col-sm-6 col-md-3">
									<div class="container">
										<div class="row">
											<section class="dark-translucent-bg parallax background-img-10 pv-40" style="background-position: 1000% 0%;">
												<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
											</section>
										</div>
									</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<section class="dark-translucent-bg parallax background-img-9 pv-40" style="background-position: 50% 50%;">
									...
									<div class="row">
										<div class="col-md-8 col-md-offset-2">
											<div class="testimonial text-center">
												...
												<div class="testimonial-body">
													<blockquote>
														<p>Através dele consigo gerenciar minha agenda de Jobs e ainda quanto ganho por mês. É demias.</p>
													</blockquote>
									...
									<div class="row">
										<div class="col-md-8 col-md-offset-2">
											<div class="testimonial text-center">
												...
												<div class="testimonial-body">
													<blockquote>
														<p>Achei super bacana eu poder avaliar os Jobs que participei.</p>
													</blockquote>
						...
						<div class="col-md-12">
							<div class="call-to-action text-center">
								<div class="row">
									...
									<div class="col-sm-4">
										<p class="mt-10"><a href="#" class="btn btn-animated btn-lg btn-gray-transparent">Cadastrar<i class="fa fa-user pl-20"></i></a></p>
									</div>
								</div>
							</div>
						</div>
